...
function useNavTree(): NavEntry[] {
    // Example notifications: '/meetings', icon: Calendar, label: 'Meetings' },
    return [
        { type: 'leaf', to: '/dashboard', icon: LayoutDashboard, label: 'Dashboard' },
        { type: 'leaf', to: '/meetings', icon: Calendar, label: 'Meetings' },
    ];
